...
import './SingleItemFullInfo.scss';
import Button from "../../../components/Button";

const SingleItemFullInfo = ({ elem, sidebarState }) => {
  const { name, detail_description, price, floor, rooms, area, guarantee } = elem;
  ...
  return (
    <div className="service-item-full-info">
      <div className="sidebar-title d-flex justify-content-between align-items-center">
        ...
        <button onClick={() => sidebarState.setSidebarIsOpen(false)}>
      ...
      <ul className="item-details d-flex justify-content-between">
        <li className="d-flex flex-column">
          ...
          <span className="title title-sm">{price} &#8381;</span>
        </li>
        <li className="d-flex flex-column">
          <span className="text-color-blackgray">Площадь</span>
          <span className="title title-sm">{area} м2</span>
        </li>
        <li className="d-flex flex-column">
          <span className="text-color-blackgray">Этажей</span>
          <span className="title title-sm">{floor}</span>
        </li>
        <li className="d-flex flex-column">
          <span className="text-color-blackgray">Комнаты</span>
          <span className="title title-sm">{rooms}</span>
        </li>
        <li className="d-flex flex-column">
      ...
      <div className="item-info">{detail_description}</div>
...
export default SingleItemFullInfo;
